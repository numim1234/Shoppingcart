                ...
                <div class="row">
                    <div class="col-md-6 col-lg-5 mx-auto pt-3">
                        <div class="login-wrap">
                            ...
                            <!-- Login Form -->
                            <form method="POST" action="register_db.php" id="registerForm"
                                enctype="multipart/form-data">
                                <div class="form-group">
                                    <div class="pass-group group-img">
                                        <i class="feather-user"></i>
                                        <input type="text" name="m_username" required class="form-control pass-input"
                                            placeholder="ไอดีผู็ใช้งาน">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="pass-group group-img">
                                        ...
                                        <input type="password" name="m_password" required
                                            class="form-control pass-input" placeholder="รหัสผ่านใช้งาน">
                                    </div>
                                </div>
                                ...
                                <div class="form-group group-img">
                                    ...
                                    <input type="tel" name="m_tel" required class="form-control"
