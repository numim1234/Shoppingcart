...
<div class="promo-page-wrap">
    ...
    <div class="promo-hero-card">
        <div>
            <h2 class="promo-hero-title">➕ Add Promotion</h2>
            <p class="promo-hero-desc">เพิ่มโปรโมชั่นใหม่ กำหนดเงื่อนไข ส่วนลด และเลือกสินค้าที่เข้าร่วมรายการ</p>
        </div>
    ...
    <div class="promo-main-card">
        <div class="promo-card-head">
            <div>
                <h3 class="promo-card-title">ฟอร์มเพิ่มโปรโมชั่น</h3>
                <div class="promo-card-subtitle">กรอกข้อมูลโปรโมชั่นให้ครบถ้วนก่อนบันทึก</div>
            </div>
        </div>

        <form action="promotion_add_db.php" method="post" id="promoForm">
            <div class="promo-card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="promo-label">ชื่อโปรโมชั่น</label>
                        <input type="text" name="promo_name" class="form-control promo-input" required>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" name="start_date" class="form-control promo-input" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="promo-label">วันที่สิ้นสุดโปรโมชั่น</label>
                        <input type="date" name="end_date" class="form-control promo-input" required>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="apply_type" id="apply_type" class="form-control promo-select" required>
                            <option value="product">เฉพาะสินค้าที่เลือก</option>
                            <option value="all">ทั้งร้าน</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="promo_detail" rows="4" class="form-control promo-textarea"></textarea>
                    </div>
                </div>
                ...
                <div id="product-section" class="promo-product-wrap">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                        <div>
                            ...
                            <div class="promo-section-subtitle">ใช้สำหรับโปรโมชั่นที่กำหนดเฉพาะสินค้า</div>
                        </div>
            ...
            <div class="promo-footer">
                <button type="submit" class="btn promo-btn promo-btn-success">
                    <i class="fas fa-save me-1"></i> บันทึกโปรโมชั่น
                </button>
