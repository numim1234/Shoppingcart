    ...
    <div class="container-fluid page-wrap">
        ...
        <div class="page-head">
            <div>
                ...
                <div class="page-subtitle">จัดการข้อมูลผู้ดูแลระบบทั้งหมดในหน้าจอเดียว</div>
            </div>

            <div class="page-action">
                <a href="admin.php?act=add" class="btn btn-add">
                    <i class="fas fa-plus me-2"></i>เพิ่มแอดมิน
                </a>
            </div>
        </div>
        ...
        <div class="hero-card">
            <div>
                <h2 class="hero-title">👨‍💼 Admin Management</h2>
                <!-- <p class="hero-desc">ปรับหน้าตาให้ไปในทิศทางเดียวกับ dashboard ใหม่ และยังใช้ข้อมูลเดิมทั้งหมด</p> -->
            </div>
            <div class="hero-icon">
        ...
        <div class="stats-row">
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-label">จำนวนแอดมินทั้งหมด</div>
            ...
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-label">แอดมินที่เปิดใช้งาน</div>
            ...
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-label">แอดมินที่ปิดใช้งาน</div>
                    <div class="stat-value">
                        <?= number_format(count(array_filter($resultMem, function ($item) {
              return (int)$item['m_status'] !== 1;
            }))) ?>
        ...
        <div class="main-card">
            <div class="card-head">
                <div>
                    <h3 class="card-title">รายการผู้ดูแลระบบ</h3>
            ...
            <div class="card-body-custom">
                <div class="table-responsive">
                    <table id="example1" class="table align-middle table-modern w-100">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 22%;">ข้อมูลผู้ใช้</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-user">
                                        <div class="table-user-meta">
                                            ...
                                            <div class="table-user-email">ผู้ดูแลระบบ</div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="action-group">
                                        <a href="admin.php?act=edit&m_id=<?php echo (int)$row_member['m_id']; ?>"
                    ...
                    <div class="empty-cover">ยังไม่มีข้อมูลผู้ดูแลระบบ</div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
